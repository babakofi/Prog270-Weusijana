...
function writeFile(localFileName, nameOnS3, binary) {
	...
	nameOnS3 = "Week09-AndroidBootstrap" + nameOnS3;
...
walkDirs('Source');
walkDirs('Style');
writeFile('Avast.html', '/Avast.html', false);
writeFile('Jamendo.html', '/Jamendo.html', false);
writeFile('Screenshot.png', '/Screenshot.png', false);
writeFile('Server.js', '/Server.js', false);
writeFile('Thumbs.db', '/Thumbs.db', false);
